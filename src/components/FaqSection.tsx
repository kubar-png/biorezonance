...
const faqs: Faq[] = [
  { q: "Jak dlouho trvá sezení?", cat: "prvni", a: <>První návštěva 120-150 minut. Kontrolní sezení kolem 90 minut. U dětí první návštěva 60-90 minut, kontrolní hodinku. Akutní ošetření na konkrétní problém (nejčastěji infekce) zhruba hodinu.</> },
  { q: "Kolikrát budu muset přijít?", cat: "obecne", a: <>Záleží na tom, co spolu řešíme. Když se eliminují zátěže, jsou potřeba zhruba tři sezení. Udržovací harmonizace po 3-6 měsících. Akutní alergie 3× po týdnu. Hubnutí 12× po týdnu. <strong>Odvykání kouření - když opravdu chcete přestat - stačí jednou.</strong></> },
  { q: "Kolik to stojí?", cat: "pojistovna", a: <>První sezení 2 500 Kč (dospělí) / 1 500 Kč (děti). Kontrolní 2 000 Kč / 1 000 Kč. Konzultace 1 000 Kč. Zaměřeno na emoce 1 000 Kč / 60 min. Základní Asyrská masáž 1 000 Kč / 60 min. Akutní ošetření 1 500 Kč/hod. Příplatek za víkend nebo domácí prostředí 1 500 Kč. Nosné médium (niklová destička, kapky) 200 Kč. Množstevní slevy a barter po domluvě. Pokud přijdete po více než roce od poslední návštěvy, počítá se jako první sezení.</> },
