          ...
          <div className="foot-sign">
            <a href="https://studiojakub.cz" target="_blank" rel="noopener">
              <span className="sig-mark" aria-hidden="true">
                <svg viewBox="0 0 128 128"><rect width="128" height="128" fill="#E63946" /><g transform="translate(64 64) scale(1.12) translate(-61.6 -65.925)"><polygon points="96.23,32.88 70.21,63.13 103.56,85.03 66.75,69.64 56.22,108.12 59.49,68.36 19.64,70.23 58.46,61.06 44.36,23.73 65.09,57.82" fill="#F1F0EC" /></g></svg>
              </span>
